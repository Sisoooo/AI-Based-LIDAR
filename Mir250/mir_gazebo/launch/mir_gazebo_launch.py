...
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, OpaqueFunction, \
                           SetLaunchConfiguration, ExecuteProcess, SetEnvironmentVariable
...
def generate_launch_description():
    ...
    mir_models_path = os.path.join(mir_gazebo_dir, 'worlds', 'include')
    small_house_models_path = os.path.join(mir_gazebo_dir, 'worlds', 'small_house_models')
    hospital_models_path = os.path.join(mir_gazebo_dir, 'worlds', 'hospital_models')
    gazebo_model_path = hospital_models_path + ':' + small_house_models_path + ':' + mir_models_path + ':' + os.environ.get('GAZEBO_MODEL_PATH', '')
